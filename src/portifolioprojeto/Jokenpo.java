...
public class Jokenpo extends JFrame {
	...
	public Jokenpo() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(Jokenpo.class.getResource("/icones/papel.png")));
		setTitle("JOKENPO");
		...
		btnPedra.setIcon(new ImageIcon(Jokenpo.class.getResource("/icones/pedra.png")));
		btnPedra.setBounds(20, 11, 64, 64);
		...
		btnPapel.setIcon(new ImageIcon(Jokenpo.class.getResource("/icones/papel.png")));
		btnPapel.setBounds(20, 100, 64, 64);
		...
		btnTesoura.setIcon(new ImageIcon(Jokenpo.class.getResource("/icones/tesoura.png")));
		btnTesoura.setBounds(20, 189, 64, 64);
		contentPane.add(btnTesoura);
		
		lblComputador = new JLabel("");
		lblComputador.setBounds(108, 100, 219, 152);
		contentPane.add(lblComputador);
		
		JLabel lblResultado = new JLabel("Resultado");
		lblResultado.setBounds(162, 45, 89, 19);
		...
		btnLimpar.setBounds(142, 11, 89, 23);
	...
	case 1:
		...
		lblComputador.setIcon(new ImageIcon(Jokenpo.class.getResource("/icones/pcpedra.png")));
		break;
	case 2:
		System.out.println("Computador escolheu PAPEL");
		lblComputador.setIcon(new ImageIcon(Jokenpo.class.getResource("/icones/pcpapel.png")));

		break;
	case 3:
		System.out.println("Computador escolheu TESOURA");
		lblComputador.setIcon(new ImageIcon(Jokenpo.class.getResource("/icones/pctesoura.png")));
