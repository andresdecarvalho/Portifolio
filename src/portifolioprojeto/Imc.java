...
public class Imc extends JFrame {
	 ...
	 */
	public Imc() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(Imc.class.getResource("/icones/imc.png")));
		...
		btnLimpar.setIcon(new ImageIcon(Imc.class.getResource("/icones/sair.png")));
		...
		lblStatus.setIcon(new ImageIcon(Imc.class.getResource("/icones/tabela_imc.jpg")));
